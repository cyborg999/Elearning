      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="row">
            ...
            <div class="columns col-lg-6">
              <a href="learning.php?type=basic" class="btn btn-success btn-md pull-right">Add New</a>
            </div>
          </div>
          <br>
          <div class="row">
            <div class="columns all-games col-lg-12 col-md-12 col-sm-12">
              <?php foreach($games->getAllBasicGames() as $idx => $game): ?>
                <?php
                  $cover = explode(".",$game['folder_id']);
                  $cover = $cover[0]."/".$game['cover'];
                ?>
                <div class="game col-lg-3 col-md-2 col-sm-6">
