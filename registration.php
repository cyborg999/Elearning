      ...
      <div class="row" style="margin-top:60px;">
          ...
          <?php else: ?>
              <?php if(isset($_POST['addUser'])): ?>
                <p class="bg-success" style="padding:5px;border-radius:5px;">User is succesfully registered.</p>
              <?php endif ?>
          <?php endif ?>
        <div class="jumbotron">
          <div class="container">
              
            <h1>Register <?php echo (isset($_GET['type'])) ? "an Admin" : 'a User'; ?> Account</h1>
            <form method="post">
              <input type="hidden" class="form-control" name="addUser" value="true"/>
              <?php $type = (isset($_GET['type'])) ? "admin" : 'user'; ?>
