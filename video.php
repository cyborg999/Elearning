        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                  ...
                  <div class="row">
                    <div class="columns col-lg-12 col-md-12 col-sm-12">
                      <div class="columns col-lg-12 col-md-12 col-sm-12">
                        ...
                        <p class="lead">
                          Upload/Drag&Drop a video file first to add a new record.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div class="clearfix row">
            <form action="process.php">
              <input type="hidden" name="type" id="gameType" value="video">
              <div class="columns col-lg-12 col-md-12 col-sm-12">
                <label>Title</label>
                ...
                <input style="margin-top:20px" disabled id="btnAddVideo" type="submit" class="btn btn-success btn-lg">
              </div>
            </form>
          </div>
        </div>
