        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="row">
            <div class="columns col-lg-6">
              <h1>All Basic Lesson</h1>
            </div>
            <div class="columns col-lg-6">
              <a href="video.php" class="btn btn-success btn-md pull-right">Add New</a>
            </div>
          </div>
          <br>
          <div class="row">
            <div class="columns all-games col-lg-12 col-md-12 col-sm-12">
              <?php foreach($games->getAllVideo() as $idx => $game): ?>
                <?php
                  $main = explode(".",$game['folder_id']);
                  $cover = $main[0]."/".$game['cover'];
                  $path  = $main[0]."/".$game['folder_id'];
                ?>

                <div class="game col-lg-4 col-md-3 col-sm-6">
